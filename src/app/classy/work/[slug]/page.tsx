...
export async function generateMetadata(props: PageProps<"/classy/work/[slug]">) {
...
export default async function WorkCaseStudyPage(props: PageProps<"/classy/work/[slug]">) {
  const { slug } = await props.params;
  const project = getProject(slug);
  if (!project) notFound();
